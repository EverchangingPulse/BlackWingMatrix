...
This document records third-party material, prior work, and attribution relevant to Raven Studio Adaptive Test.
...
3. This repository preserves attribution to Can Mekik and pyRavenMatrices rather than presenting upstream work as original Raven Studio material.
4. Anyone intending to redistribute, modify, or otherwise rely on material substantially derived from pyRavenMatrices should independently verify the permissions applicable to that upstream material or obtain permission from the relevant rightsholder where necessary.

## Runtime dependencies

The standalone Raven Studio application is delivered as HTML/CSS/JavaScript/SVG and does not bundle Python runtime dependencies merely because an upstream Python project may use them.
